...
const CHARACTERS = [
  ...
  // Nỗi đau & Chia ly
  { hanzi: "泪", pinyin: "lèi", meaning: "nước mắt", category: "pain", hsk: 4, emotional_hook: "Nước từ mắt — thơ nhất tiếng Trung" },
  ...
  { hanzi: "笑", pinyin: "xiào", meaning: "nụ cười", category: "strength", hsk: 1, emotional_hook: "Vũ khí mạnh nhất" },
  ...
  { hanzi: "福", pinyin: "fú", meaning: "hạnh phúc, may mắn", category: "strength", hsk: 3, emotional_hook: "Hạnh phúc không tìm mà đến" },
];
